...
defmodule AriaForge.NativeService.Context do
  ...
  def get_scene_id(pid) do
    try do
      AriaForge.SceneManager.get_scene_id(pid)
    rescue
      _ -> "default"
    end
  end
  ...
  # In development, generates and persists a key in ~/.aria_forge/macaroon_secret
  defp get_or_create_secret_key do
    # First, try explicit configuration
    case Application.get_env(:aria_forge, :macaroon_secret_key) do
      nil ->
